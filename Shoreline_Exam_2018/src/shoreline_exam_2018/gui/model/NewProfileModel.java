...
public class NewProfileModel
{
    ...
    public void handleSaveStructure()
    {
        ...
        if (!txtFieldProfileName.getText().isEmpty() && txtFieldProfileName.getText() != null)
        {
            ...
            StructEntityObject seo = new StructEntityObject(0, profileName, result);
            ...
            try
            {
                ...
                bll.addLog(LogType.PROFILE, "Structure " + profileName + " was successfully added to the system.");
        ...
        if (!txtFieldProfileName.getText().isEmpty() && txtFieldProfileName.getText() != null)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    Profile profile = bll.addProfile(profileName, seo, headersIndexAndExamples);
                    ...
                    bll.addLog(LogType.PROFILE, "Profile " + profileName + " was successfully added to the system.");
    ...
    void setProfilesModel(ProfilesModel pm)
    {
        this.pm = pm;
    }
}
